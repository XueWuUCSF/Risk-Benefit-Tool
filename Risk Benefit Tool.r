          ...
          tabItem(tabName = 'introduction',
                  ...
                  fluidRow(
                    ...
                    column(10,
                           ...
                           for 25 hours per month. If usage has been exceeded, you may download the <a href=‘http://www.rstudio.com’> R code</a> to run the App directly on your device. If you have 
